    ...
    <div style={{ 
      ...
      <nav style={{ 
        ...
        <div style={{ display: 'flex', gap: '6px', alignItems: 'center', flexWrap: 'wrap' }}>
          <button 
            ...
            style={{ 
              ...
              fontSize: '12px', color: activeTab === 'home' ? '#0f172a' : '#334155',
          ...
          <button 
            ...
            style={{ 
              background: 'none', border: 'none', cursor: 'pointer', 
              fontWeight: activeTab === 'confession' ? '800' : '600', 
              fontSize: '12px', color: activeTab === 'confession' ? '#0f172a' : '#334155',
              padding: '6px 8px', borderRadius: '6px',
              backgroundColor: activeTab === 'confession' ? '#f1f5f9' : 'transparent'
            }}
          >
            💬 CONFESSION
          </button>
        ...
        <div 
          ...
          style={{ cursor: 'pointer', userSelect: 'none', textAlign: 'center', order: 3, width: '100%', marginTop: '4px' }}
          title="Klik 3 kali untuk panel admin"
        >
          <span style={{ fontWeight: '800', fontSize: '13px', letterSpacing: '0.5px', color: '#0f172a' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'flex-end', gap: '10px' }}>
          {isAdmin && (
            <button onClick={handleLogout} style={{ backgroundColor: '#fee2e2', color: '#dc2626', border: '1px solid #fca5a5', padding: '4px 10px', borderRadius: '6px', cursor: 'pointer', fontSize: '11px', fontWeight: 'bold' }}>
              Keluar
            </button>
          )}
        </div>
      ...
      {activeTab === 'home' ? (
        <div style={{ maxWidth: '720px', margin: '0 auto', padding: '40px 16px', textAlign: 'center', boxSizing: 'border-box' }}>
          <div style={{ backgroundColor: '#ffffff', padding: '40px 24px', borderRadius: '24px', border: '2px solid #0f172a', boxShadow: '0 8px 16px rgba(0,0,0,0.03)' }}>
            <span style={{ fontSize: '40px' }}>🎓</span>
            <h1 style={{ fontSize: '28px', fontWeight: '900', margin: '15px 0 10px 0', color: '#0f172a' }}>
              Selamat Datang ke <span style={{ color: '#e11d48' }}>UMS HUB</span>
            </h1>
            <p style={{ color: '#334155', fontSize: '14px', lineHeight: '1.6', maxWidth: '500px', margin: '0 auto 25px auto', fontWeight: '500' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'center', gap: '12px', flexWrap: 'wrap' }}>
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                style={{ backgroundColor: '#ffffff', color: '#0f172a', border: '2px solid #0f172a', padding: '12px 24px', borderRadius: '12px', fontWeight: '700', fontSize: '14px', cursor: 'pointer', textDecoration: 'none', display: 'inline-block' }}
              >
                E-Hailing UMS 🚗
              </a>
            </div>
        ...
        <div style={{ maxWidth: '720px', margin: '0 auto', padding: '30px 16px', boxSizing: 'border-box' }}>
          ...
          <div style={{ marginBottom: '20px' }}>
            <h2 style={{ fontSize: '26px', fontWeight: '900', margin: '0 0 4px 0', letterSpacing: '-0.5px', color: '#0f172a' }}>Community Confessions</h2>
